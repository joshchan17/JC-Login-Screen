...
form.json input[type='text'],form.json label,form.json input[type='submit'],form.json textarea{
  margin-left: 10px;
  margin-right: 10px;
}
form.json input[type='submit']{
  margin-bottom: 10px;
}
form.json textarea{
  margin-bottom: 5px;
           ...
           <!-- Sidebar Holder -->
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-default">
                  ...
                  <div id='msg'>
    Press this button to create a new task.
</div>
<button>Create new task</button>
<div id='form'>
  <form action='#'>
    <div id='head'></div>
    <h2>  Enter Task Attributes </h2>
    <label> Title</label><br />
    <input type='text' name ="title"/><br />
    <label> Today's Date (Start date for task)</label><br />
    <input type='text' name = "StartDate"/><br />
    <label> Projected End Date</label><br />
    <input type='text' name ="EndDate"/><br />
    <label> Description</label><br />
    <textarea input type ="text" name ="Description"></textarea><br />
